...
public class CallTestSAPData
{
    ...
    static Properties getDestinationPropertiesFromUI()
    {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "10.5.1.18");
        connectProperties.setProperty(DestinationDataProvider.JCO_SYSNR,  "00");
        connectProperties.setProperty(DestinationDataProvider.JCO_CLIENT, "900");
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "PDAUSER");
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "init01");
     ...
     * @throws JCoException
     */
    public static JCoDestination JcoConnect(String destinationName) throws JCoException
    {
        JCoDestination destination = JCoDestinationManager.getDestination(destinationName);
//        destination.changePassword("PDAUSER", "init01");
...
//        step2ConnectUsingPool();
        step3SimpleCall(JcoConnect(ABAP_AS));
//        step4WorkWithTable();
